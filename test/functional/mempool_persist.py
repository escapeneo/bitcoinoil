...
By default, bitcoinoild will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinoild from writing mempool.dat to disk. Verify that `savemempool` fails")
