...
class NetTest(BitcoinOilTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=19712)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 19712)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=19712), {"success": False})
