...
"""Verify that starting bitcoinoil with -h works as expected."""

from test_framework.test_framework import BitcoinOilTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinoil with -h for help text")
        ...
        self.log.info("Start bitcoinoil with -version for version information")
        ...
        self.log.info("Start bitcoinoild with -fakearg to make sure it does not start")
