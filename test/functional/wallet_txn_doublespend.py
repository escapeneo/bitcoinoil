...
class TxnMallTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BTCO:
        ...
        # First: use raw transaction API to send 1240 BTCO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BTCO coin each
        ...
        # Node0's balance should be starting balance, plus 50BTCO for another
        ...
        # Node0's total balance should be starting balance, plus 100BTCO for
