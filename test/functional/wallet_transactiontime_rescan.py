...
class TransactionTimeRescanTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BTCO and create transactions
        ...
        # generate some btco to create transactions and check blockcount
        ...
        # send 10 btco to user's first watch-only address
        self.log.info('Send 10 btco to user')
        ...
        # send 5 btco to our second watch-only address
        self.log.info('Send 5 btco to user')
        ...
        # send 1 btco to our third watch-only address
        self.log.info('Send 1 btco to user')
