...
class TestShell:
    """Wrapper Class for BitcoinOilTestFramework.

    The TestShell class extends the BitcoinOilTestFramework
    ...
    class __TestShell(BitcoinOilTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinOilTestFramework child class.
            self.num_nodes = 1
