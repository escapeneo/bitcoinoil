...
class AbandonConflictTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        ...
        inputs = []
        # spend 10btco outputs from txA and txB
        ...
        # Identify the 14.99998btco output
        ...
        # Verify that B and C's 10 BTCO outputs are available for spending again because AB1 is now conflicted
        newbalance = alice.getbalance()
        assert_equal(newbalance, balance + Decimal("20"))
        balance = newbalance

        # There is currently a minor bug around this and so this test doesn't work.  See Issue #7315
        # Invalidate the block with the double spend and B's 10 BTCO output should no longer be available
