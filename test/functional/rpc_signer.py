...
Verify that a bitcoinoild node can use an external signer command.
...
class RPCSignerTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitcoinoild with -signer=<cmd>',
