...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinOilTestFramework
    pass


class ExampleTest(BitcoinOilTestFramework):
    # Each functional test is a subclass of the BitcoinOilTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinOilTestFramework class so other tests can use it."""
