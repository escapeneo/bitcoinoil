...
"""
Test starting bitcoinoild with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitcoinOilTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bitcoinoild has bound on "::1" (for RPC) and "::" (for P2P).
