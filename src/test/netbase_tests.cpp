...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinoilcore.org", "www.bitcoinoilcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcoinoilcore.org]", "www.bitcoinoilcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitcoinoilcore.org:80", "www.bitcoinoilcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinoilcore.org]:80", "www.bitcoinoilcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19712", "127.0.0.1", 19712));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19712", "127.0.0.1", 19712));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19712", "::ffff:127.0.0.1", 19712));
    BOOST_CHECK(TestSplitHost("[::]:19712", "::", 19712));
    BOOST_CHECK(TestSplitHost("::19712", "::19712", 0));
    BOOST_CHECK(TestSplitHost(":19712", "", 19712));
    BOOST_CHECK(TestSplitHost("[]:19712", "", 19712));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoinoilcore.org:65536", "www.bitcoinoilcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinoilcore.org:0", "www.bitcoinoilcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinoilcore.org:", "www.bitcoinoilcore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19712", "127.0.0.1:19712"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19712", "[::]:19712"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
