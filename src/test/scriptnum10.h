...
#ifndef BITCOINOIL_TEST_SCRIPTNUM10_H
#define BITCOINOIL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinOil Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINOIL_TEST_SCRIPTNUM10_H
