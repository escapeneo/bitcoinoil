...
#ifndef BITCOINOIL_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINOIL_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINOIL_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
