...
//
// The bitcoinoil-chainstate executable serves to surface the dependencies required
// by a program wishing to use BitcoinOil Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from BitcoinOil Core's coding style.
//
// It is part of the libbitcoinoilkernel project.
