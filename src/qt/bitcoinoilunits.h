...
#ifndef BITCOINOIL_QT_BITCOINOILUNITS_H
#define BITCOINOIL_QT_BITCOINOILUNITS_H
...
/** BitcoinOil unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinOilUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinOilUnits(QObject *parent);

    /** BitcoinOil units.
      @note Source: https://en.bitcoinoil.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BTCO,
        mBTCO,
