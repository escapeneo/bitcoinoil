...
#ifndef BITCOINOIL_QT_GUIUTIL_H
#define BITCOINOIL_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinOil Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinoil:" URI into recipient object, return true on successful parsing
