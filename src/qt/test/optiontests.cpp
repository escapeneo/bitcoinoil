...
{
    // Test regression https://github.com/bitcoinoil/bitcoinoil/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitcoinoil-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitcoinoil-core/gui/pull/568.
    // With fListen=false in ~/.config/BitcoinOil/BitcoinOil-Qt.conf and all else left as default,
    // bitcoinoil-qt should set both -listen and -listenonion to false and start successfully.
