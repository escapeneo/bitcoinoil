...
//! Entry point for BitcoinOilApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinOilApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinOilGUI tests.
void AppTests::guiTests(BitcoinOilGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinOilGUI::consoleShown, this, &AppTests::consoleTests);
