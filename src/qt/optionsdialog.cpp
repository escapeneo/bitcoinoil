      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitcoinoilAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinoilAtStartup);
    ...
    ui->bitcoinoilAtStartup->setToolTip(ui->bitcoinoilAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinoilAtStartup->setText(ui->bitcoinoilAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinOilConfButton->setToolTip(ui->openBitcoinOilConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinOilUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinoilAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBTCOontrols);
...
void OptionsDialog::on_openBitcoinOilConfButton_clicked()
{
