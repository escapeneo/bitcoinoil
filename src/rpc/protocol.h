...
#ifndef BITCOINOIL_RPC_PROTOCOL_H
#define BITCOINOIL_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinoild
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinOil is not connected
...
#endif // BITCOINOIL_RPC_PROTOCOL_H
