...
#ifndef BITCOINOIL_INTERFACES_INIT_H
#define BITCOINOIL_INTERFACES_INIT_H
...
//! (bitcoinoil-gui, bitcoinoil-node, bitcoinoil-wallet, bitcoinoild, bitcoinoil-qt) and each
...
#endif // BITCOINOIL_INTERFACES_INIT_H
