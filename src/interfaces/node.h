...
#ifndef BITCOINOIL_INTERFACES_NODE_H
#define BITCOINOIL_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinoil node (bitcoinoild process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bitcoinoil.conf.
...
#endif // BITCOINOIL_INTERFACES_NODE_H
