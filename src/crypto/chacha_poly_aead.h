...
#ifndef BITCOINOIL_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINOIL_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinoil.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinoil combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinoil cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinoil are relatively fast in
...
#endif // BITCOINOIL_CRYPTO_CHACHA_POLY_AEAD_H
