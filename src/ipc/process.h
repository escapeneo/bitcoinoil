...
#ifndef BITCOINOIL_IPC_PROCESS_H
#define BITCOINOIL_IPC_PROCESS_H
...
//! IPC process interface for spawning bitcoinoil processes and serving requests
...
#endif // BITCOINOIL_IPC_PROCESS_H
