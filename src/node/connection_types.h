...
#ifndef BITCOINOIL_NODE_CONNECTION_TYPES_H
#define BITCOINOIL_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitcoinoil-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitcoinOil’s Peer-to-Peer Network")
...
#endif // BITCOINOIL_NODE_CONNECTION_TYPES_H
