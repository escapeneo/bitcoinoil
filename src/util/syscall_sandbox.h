...
#ifndef BITCOINOIL_UTIL_SYSCALL_SANDBOX_H
#define BITCOINOIL_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitcoinoild initialization if BitcoinOil Core was compiled
...
#endif // BITCOINOIL_UTIL_SYSCALL_SANDBOX_H
