...
#ifndef BITCOINOIL_UTIL_MESSAGE_H
#define BITCOINOIL_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinoil address, it must refer to a public key.
...
#endif // BITCOINOIL_UTIL_MESSAGE_H
