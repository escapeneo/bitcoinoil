...
#ifndef BITCOINOIL_WALLET_WALLETUTIL_H
#define BITCOINOIL_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinoil from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINOIL_WALLET_WALLETUTIL_H
