...
#ifndef BITCOINOIL_WALLET_TRANSACTION_H
#define BITCOINOIL_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitcoinoil node, and set to 0 for transactions that were created
...
#endif // BITCOINOIL_WALLET_TRANSACTION_H
