...
#ifndef BITCOINOIL_WALLET_SCRIPTPUBKEYMAN_H
#define BITCOINOIL_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitcoinOil Core wallet was originally a collection of unrelated private
...
#endif // BITCOINOIL_WALLET_SCRIPTPUBKEYMAN_H
