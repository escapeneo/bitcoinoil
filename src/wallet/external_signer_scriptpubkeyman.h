...
#ifndef BITCOINOIL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINOIL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINOIL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
