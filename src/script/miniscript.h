...
#ifndef BITCOINOIL_SCRIPT_MINISCRIPT_H
#define BITCOINOIL_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a bitcoinoil script
...
#endif // BITCOINOIL_SCRIPT_MINISCRIPT_H
