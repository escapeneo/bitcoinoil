...
#ifndef BITCOINOIL_SCRIPT_SCRIPT_H
#define BITCOINOIL_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinOil always counted CHECKMULTISIGs
...
#endif // BITCOINOIL_SCRIPT_SCRIPT_H
