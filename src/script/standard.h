...
#ifndef BITCOINOIL_SCRIPT_STANDARD_H
#define BITCOINOIL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitcoinoil address
 */
...
/**
 * Generate a BitcoinOil scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITCOINOIL_SCRIPT_STANDARD_H
