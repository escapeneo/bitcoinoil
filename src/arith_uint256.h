...
#ifndef BITCOINOIL_ARITH_UINT256_H
#define BITCOINOIL_ARITH_UINT256_H
...
public:
     ...
     *
     * BitcoinOil only uses this "compact" format for encoding difficulty
...
#endif // BITCOINOIL_ARITH_UINT256_H
