...
#ifndef BITCOINOIL_HEADERSSYNC_H
#define BITCOINOIL_HEADERSSYNC_H
 ...
 *
 * The BitcoinOil protocol does not offer an easy way to determine the work on a
...
#endif // BITCOINOIL_HEADERSSYNC_H
