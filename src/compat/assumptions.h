...
#ifndef BITCOINOIL_COMPAT_ASSUMPTIONS_H
#define BITCOINOIL_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinOil cannot be compiled without assertions."
#endif
...
#endif // BITCOINOIL_COMPAT_ASSUMPTIONS_H
