...
This document provides guidelines for internationalization of the BitcoinOil Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinoil_en.ts` remains unchanged.
