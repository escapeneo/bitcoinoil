BitcoinOil Core version 0.9.4 is now available from:

  https://bitcoinoil.org/bin/0.9.4/
...
this update is incompatible with the BitcoinOil system and could lead to consensus
forks.

BitcoinOil Core released binaries from https://bitcoinoil.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinoil/+archive/ubuntu/bitcoinoil
- A third-party or self-compiled BitcoinOil Core

upgrade to BitcoinOil Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
