BitcoinOil Core version *0.15.0.1* is now available from:

  <https://bitcoinoil.org/bin/bitcoinoil-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/bitcoinoil-core-0.15.0.1/>
