BitcoinOil Core version 0.9.2.1 is now available from:

  https://bitcoinoil.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCO to 0.01 BTCO
...
- Fix "Start bitcoinoil on system login"
