BitcoinOil version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinoil/files/BitcoinOil/bitcoinoil-0.5.4/
...
http://gitorious.org/bitcoinoil/bitcoinoild-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinOil-Qt notifications under Growl 1.3.
Increase required age of BitcoinOil-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinOil properly when installing BitcoinOil-Qt over it. (Windows)
