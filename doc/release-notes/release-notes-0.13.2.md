BitcoinOil Core version 0.13.2 is now available from:

  <https://bitcoinoil.org/bin/bitcoinoil-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinoil-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinoil-tx to create v2 transactions (btcodrak)
