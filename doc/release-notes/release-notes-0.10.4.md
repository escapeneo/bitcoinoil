BitcoinOil Core version 0.10.4 is now available from:

  <https://bitcoinoil.org/bin/bitcoinoil-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinoil-tx into its own package
- #6953 `dfe0d4d` Include bitcoinoil-tx binary on Debian/Ubuntu
