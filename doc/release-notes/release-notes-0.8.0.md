BitcoinOil-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinoil/files/BitcoinOil/bitcoinoil-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinOil
...
New/changed settings (command-line or bitcoinoil.conf file)
--------------------------------------------------------
