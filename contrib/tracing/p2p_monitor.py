...
""" Interactive bitcoinoild P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for BitcoinOil Core can enable. It uses BCC
...
def main(bitcoinoild_path):
    ...
    bitcoinoild_with_usdts.enable_probe(
