...
"""Example logging BitcoinOil Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitcoinoild
...
def main(bitcoinoild_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitcoinoild_with_usdts])
