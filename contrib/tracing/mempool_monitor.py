...
""" Example logging BitcoinOil Core mempool events using the mempool:added,
...
def main(bitcoinoild_path):
    bitcoinoild_with_usdts = USDT(path=str(bitcoinoild_path))

    # attaching the trace functions defined in the BPF program
    # to the tracepoints
    bitcoinoild_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    bitcoinoild_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    bitcoinoild_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    bitcoinoild_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
    bpf = BPF(text=PROGRAM, usdt_contexts=[bitcoinoild_with_usdts])
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("USAGE: ", sys.argv[0], "path/to/bitcoinoild")
        exit(1)
