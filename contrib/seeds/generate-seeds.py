...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINOIL_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINOIL_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoinoil network\n')
    ...
    g.write('#endif // BITCOINOIL_CHAINPARAMSSEEDS_H\n')
