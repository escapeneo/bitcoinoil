...
# Extract options
function __fish_bitcoinoil_tx_get_options
...
# Extract commands
function __fish_bitcoinoil_tx_get_commands
...
# Add options
complete \
    --command bitcoinoil-tx \
    --condition "not __fish_bitcoinoil_seen_cmd (__fish_bitcoinoil_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitcoinoil_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitcoinoil-tx \
    --arguments "(__fish_bitcoinoil_tx_get_commands)" \
    --no-files
