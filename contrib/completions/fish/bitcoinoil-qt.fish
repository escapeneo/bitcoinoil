...
complete --command bitcoinoil-qt --no-files

# Extract options
function __fish_bitcoinoilqt_get_options
...
complete \
    --command bitcoinoil-qt \
    --arguments "(__fish_bitcoinoilqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitcoinoil-qt \
...
complete \
    --command bitcoinoil-qt \
    --arguments "(__fish_bitcoinoilqt_get_options --nofiles)"
