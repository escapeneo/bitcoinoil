...
complete --command bitcoinoild --no-files

# Extract options
function __fish_bitcoinoild_get_options
...
complete \
    --command bitcoinoild \
    --arguments "(__fish_bitcoinoild_get_options --nofiles)"
